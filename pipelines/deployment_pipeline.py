...
def deployment_trigger(
    ...
    """
    Impelements a simple model deployment trigger that looks at the input model
    accuracy and decides if it is good enough to deploy or not.
    """
...
def continuous_deployment_pipeline(
    ...
    df = ingest_dframe(data_path=data_path)
    ...
    deploy_decision = deployment_trigger(accuracy=r2_score, config=DeploymentTriggerConfig())
