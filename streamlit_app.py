...
def main():
    st.title("Customer Satisfaction Project Using ZenML and MLFlow")

    high_level_image = Image.open("assets/high_level_overview.png")
    st.image(high_level_image, caption="High Level Pipeline")

    whole_pipeline_image = Image.open("assets/training_and_deployment_pipeline_updated.png")
    ...
    payment_sequential = st.slider("Payment Sequential")
    payment_installments = st.slider("Payment Installments")
